<?php
	...
	$id = $_GET['id'];
	$sql = "SELECT * FROM ovaglosario WHERE id = '$id'";
	$resultado = $mysqli->query($sql);
	$row = $resultado->fetch_array(MYSQLI_ASSOC);
?>
<html lang="es">
	<head>
		<title><?php echo $_SESSION["id_asignatura"];?>: Modificación de Glosario</title>
				...
				<div id="signupbox" class="col-lg-12">
					<div class="formulario">
						<div id="cabeceraformulario" class="modificacion">
							<div class="">Modificación de término</div>
						</div>  
					<div class="panel-body" >	
						<form class="form-horizontal" method="POST" action="actualizarglosario.php" autocomplete="off">
							<div class="form-group">
								<label for="termino" class="col-md-3 control-label">Término</label>
								<div class="col-md-9">
									<input type="text" class="form-control" id="termino" name="termino" placeholder="Término" value="<?php echo $row['termino']; ?>" required>
								</div>
							</div>
							<div class="form-group">
								<label for="definicion" class="col-md-3 control-label">Definición</label>
								<div class="col-md-9">
									<textarea rows="20" class="form-control enunciadocorto" id="definicion" name="definicion" placeholder="Definición"><?php echo $row['definicion']; ?></textarea>
								</div>
							</div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p ALIGN="justify">Esta área se encarga de <b>Modificación de glosarios</b>, el cual consiste en editar los  del OVA que están registrada.</p><br/>
