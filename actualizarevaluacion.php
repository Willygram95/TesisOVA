<?php
	...
	if(isNullevaluacion($tipo,$enunciado,$numopciones,$opcion1,$opcion2,$opcion3,$opcion4,$valor))
	{
		...
		$sql = "UPDATE ovaseleccion SET tipo='$tipo', enunciado='$enunciado', numopciones='$numopciones', opcion1='$opcion1', opcion2='$opcion2', opcion3='$opcion3', opcion4='$opcion4', opcioncorrecta='$opcioncorrecta', valor='$valor', id_tema='$id_tema', numerogrupo='$numerogrupo' WHERE id = '$id'";
		$resultado = $mysqli->query($sql);
		if($resultado) { 
			//$_SESSION['cualareac']=$id_areac;
			$_SESSION['tipomensajedevuelto']='exito';
			$_SESSION['mensajedevuelto']='Pregunta modificada exitosamente';
			
			}else{
			$_SESSION['tipomensajedevuelto']='error';
			$_SESSION['mensajedevuelto']='Error al modificar la pregunta';
