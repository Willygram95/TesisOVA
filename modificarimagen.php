<?php
	...
	$id = $_GET['id'];
	$id_tema = $_GET['tm'];
	$sql = "SELECT * FROM ovaimagenes WHERE id = '$id'";
...
<html lang="es">
	<head>
		<title><?php echo $_SESSION["id_asignatura"];?>: Modificación de Imagen</title>
				...
				<div id="signupbox" class="col-lg-12">
					<div class="formulario">
						<div id="cabeceraformulario">
							<div>Modificación de imagen</div>
						</div>  
					<div class="panel-body" >	
						
						<form class="form-horizontal" enctype="multipart/form-data" action="actualizarimagen.php" method="POST" autocomplete="off">
							<div class="form-group">
								<label for="nombreoriginal" class="col-md-3 control-label"><?php echo $row['nombreoriginal']; ?></label>
								<div class="col-md-9">
									<?php echo "<img class='img-responsive' src='mostrarimagen.php?id=".$row['id']."' width='200' height='150'>";?>
								</div>
							</div>							
							<div class="form-group">
