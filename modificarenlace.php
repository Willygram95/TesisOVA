<?php
	...
	$id = $_GET['id'];
	$id_tema = $_GET['tm'];
	$sql = "SELECT * FROM ovaenlaces WHERE id = '$id'";
...
<html lang="es">
	<head>
		<title><?php echo $_SESSION["id_asignatura"];?>: Modificación de Enlace</title>
				...
				<div id="signupbox" class="col-lg-12">
					<div class="formulario">
						<div id="cabeceraformulario">
							<div>Modificación de enlace</div>
						</div>    
					<div class="panel-body" >	
						<form class="form-horizontal" method="POST" action="actualizarenlace.php" autocomplete="off">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" id="url" name="url" placeholder="URL" value="<?php echo $row['url']; ?>" required>
								</div>
							</div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p ALIGN="justify">Esta área se encarga de <b>Modificación de enlaces</b>, el cual consiste en editar los enlaces del OVA que están registrada.</p><br/>
