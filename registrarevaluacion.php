<?php
	...
	if(!empty($_POST))
	{
		...
		$numerogrupo = 1;
		if(isNullevaluacion($tipo,$enunciado,$numopciones,$opcion1,$opcion2,$opcion3,$opcion4,$valor))
		{
			$errores[] = "Debe ingresar toda la información solicitada";
		}
		if(count($errores) == 0)
		{
			$registro = registraEvaluacion($tipo,$enunciado,$numopciones,$opcion1,$opcion2,$opcion3,$opcion4,$opcioncorrecta,$valor,$id_tema,$numerogrupo);			
			if($registro > 0) { 
				$_SESSION['tipomensajedevuelto']='exito';
				$_SESSION['mensajedevuelto']='Pregunta registrada exitosamente';
				$vloc="Location: administrarevaluaciones.php?id=".$id_tema;
				header($vloc);
				}else{
				$_SESSION['tipomensajedevuelto']='error';
				$_SESSION['mensajedevuelto']='Error al registrar la pregunta';
				$errores[] = "Error al registrar la pregunta";
				$vloc="Location: administrarevaluaciones.php?id=".$id_tema;
				header($vloc);
			}	
		}
...
<html>
	<head>
		<title><?php echo $_SESSION["id_asignatura"];?>: Registro de Pregunta</title>
			...
			<div class="row areasuperioradmin">
				<div class="container infotemaaux">
					<div class="row titulodetemaadmin">
						<a href="administrarevaluaciones.php?id=<?php echo $id_tema; ?>" data-toggle="tooltip" title="Regresar"><span class="glyphicon glyphicon-chevron-left"></span></a>
					...
					<div class="panel-body" >
						<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
							...
							<div class="form-group">
								<label for="tipo" class="col-md-3 control-label">Tipo de pregunta</label>
								<div class="col-md-9">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" name="valor" placeholder="Valor" value="<?php if(isset($valor)) echo $valor; ?>" required >
								</div>
							</div>	
							...
							<div class="form-group">                             
								<div class="col-md-offset-3 col-md-9">
									...
									<a href="administrarevaluaciones.php?id=<?php echo $id_tema; ?>" class="btn">Cancelar</a> 
								</div>
							</div>
						</form>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p ALIGN="justify">Esta área se encarga de <b>Registro de pregunta</b>, el cual consiste en ingresar las preguntas de la evaluación.</p>
						<p ALIGN="justify">El área central de la página le muestra el formulario con los ítem necesario para el registro, los cuales son:</p><br/>
							  
							  <p ALIGN="justify"><b>Tipo de pregunta:</b> indicar si es simple o de selección (verdadero y falso).</p>
							  <p ALIGN="justify"><b>Enunciado:</b> colocar el texto, formular la pregunta.</p>
							  <p ALIGN="justify"><b>Valor:</b> colocar en número la puntuación de la pregunta.</p><br/>
							  ...
							  <p ALIGN="justify"><b>Opción correcta:</b> cuál de las opciones escrita en los campos anteriores es la correcta.</p><br/>
