...
<html lang="es">
	<head>
		<title><?php echo $_SESSION["id_asignatura"];?>: Modificación de Pregunta</title>
				...
				<div id="signupbox" class="col-lg-12">
					<div class="formulario">
						<div id="cabeceraformulario">
							<div>Modificación de pregunta</div>
						</div>  
					<div class="panel-body" >	
						<form class="form-horizontal" method="POST" action="actualizarevaluacion.php" autocomplete="off">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" name="valor" placeholder="Valor" value="<?php echo $row['valor']; ?>" required >
								</div>
							</div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p ALIGN="justify">Esta área se encarga de <b>Modificación de evaluación/b>, el cual consiste en editar las evaluaciones correspondiente al OVA que están registrada.</p><br/>
